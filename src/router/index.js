...
export const asyncRouterMap = [
{
    ...
    component: Layout,
    name: "招聘管理",
    meta: { title: "招聘管理", icon: "menu-fold",role: ['0','1','2'],btnPermissions:['新建','查询','重置'] }
},
{
    path: "/userpower1",
    component: Layout,
    ...
    name: "权限测试1",
    meta: { title: "权限测试1", icon: "appstore", role: ['0', '1', '2'] },
    children: [{
        path: "1-1",
        name: "测试权限1-1",
        component: () =>
            import("@/views/userpower1/1-1"),
        meta: { title: "1-1", role: ['0','1','2'] },
        children: [{
            path: "1-1-1",
            name: "测试权限1-1-1",
            component: () =>
                import("@/views/userpower1/1-1-1"),
            meta: { title: "1-1-1", role: ['0','1','2'] },
        }],
    },
    {
        path: "1-2",
...
},
{
    ...
    name: "权限测试2",
    meta: { title: "权限测试2", icon: "robot", role: ['0','1','2'] },
    children: [{
        path: "2-1",
        name: "测试权限2-1",
        component: () =>
            import("@/views/userpower2/2-1"),
        meta: { title: "2-1", role: ['0','1','2'] }
    },
    {
        path: "2-2/:userId",
        name: "测试权限2-2",
...
},
{
    ...
    name: "添加地区",
    meta: { title: "添加地区", icon: "bug", role: ['0','1','2'] },
    children: [{
        path: "buttonRole",
        name: "添加地区",
        component: () =>
            import("@/views/modal/index"),
        meta: { title: "添加地区", role: ['0','1','2'] }
    },
    ]
},
{
    ...
    redirect: "/power",
    name: "权限分配",
    meta: { title: "权限分配", icon: "aliwangwang", role: ['0','1','2'] },
    children: [{
        path: "power",
        name: "权限分配",
        router: "/power/power",
